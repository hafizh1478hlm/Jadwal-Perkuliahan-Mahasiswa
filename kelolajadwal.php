...
<body>
  ...
  <div class="container">
    <h1>Kelola Jadwal</h1>
    <p>
      Klik tanggal pada kalender untuk menambahkan, mengubah, atau menghapus jadwal dan catatan sesuai kebutuhanmu.
    </p>
      ...
      <div class="modal-body-split">
        ...
        <div class="side-left">
          ...
          <div class="input-group">
            <label for="matkulInput">Mata Kuliah</label>
            <input type="text" id="matkulInput" list="matkulList" placeholder="Pilih Matkul" autocomplete="off" />
            <datalist id="matkulList"></datalist>
          </div>

          <div class="input-group">
            <label for="dosenInput">Dosen</label>
            <input type="text" id="dosenInput" list="dosenList" placeholder="Nama Dosen" autocomplete="off" />
            <datalist id="dosenList"></datalist>
          </div>

          <div class="input-group">
            <label for="ruanganInput">Ruangan</label>
            <input type="text" id="ruanganInput" list="ruanganList" placeholder="Contoh: TA 10.4" autocomplete="off" />
        ...
        <div class="side-right">
          <div class="input-group">
            ...
            <input type="text" id="manualTimeInput" placeholder="Contoh: 07:30 - 09:00" autocomplete="off" />
          </div>

          <div class="input-group">
            <label for="catatanInput">Catatan Tambahan</label>
            <input type="text" id="catatanInput" placeholder="Kuis, Tugas, dll..." autocomplete="off" />
          </div>

          <div class="modal-footer">
            <button id="batalJadwal" class="btn-secondary" type="button">BATAL</button>
            <button id="kirimJadwal" class="btn-primary" type="button">KIRIM</button>
          </div>
        </div>
