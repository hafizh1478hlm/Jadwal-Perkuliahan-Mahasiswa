...
<body>
                ...
                <div class="col-md-10">
                    ...
                    <div class="features-grid">
                        <div class="feature-item">
                            ...
                            <p>Memungkinkan mahasiswa melihat jadwal kuliah terbaru, lokasi ruangan, dan informasi dosen
                                pengampu secara instan.</p>
                        </div>

                        <div class="feature-item">
                            <i class="fas fa-edit"></i>
                            <h4>Personalisasi Jadwal</h4>
                            <p>Fitur interaktif untuk menambahkan catatan pribadi atau agenda tambahan pada tanggal
                                tertentu sesuai kebutuhan akademik masing-masing.</p>
                        </div>

                        <div class="feature-item">
                            <i class="fas fa-shield-alt"></i>
                            <h4>Keamanan Data</h4>
                            <p>Sistem login terintegrasi memastikan data jadwal dan catatan pribadi hanya dapat dikelola
                                oleh pemilik akun yang sah.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="team-section" id="tim">
        <div class="container">
            <h2>Profil Tim Pengembang:</h2>
            <p>
                Situs "Jadwal Perkuliahan Mahasiswa (Pribadi)" ini dikembangkan oleh Mahasiswa Teknik Informatika
                Politeknik Negeri Batam
                tim IFPagi1C-6 sebagai solusi inovatif untuk manajemen waktu akademik mahasiswa Teknik Informatika.
            </p>
            ...
            <div class="team-container">
                    ...
                    <div class="role-overlay">
                        <div class="role-overlay">
                            <div class="role-wrapper">
                                <span class="role-anggota">Anggota Tim</span>
                                <a href="https://wa.me/6282288190240" target="_blank" class="wa-icon">
                ...
                <div class="team-card">
                    ...
                    <div class="role-overlay">
                        <div class="role-overlay">
                            <div class="role-wrapper">
                                <span class="role-anggota">Anggota Tim</span>
                                <a href="https://wa.me/6283152347199" target="_blank" class="wa-icon">
                                    <i class="fa-brands fa-whatsapp"></i>
                                </a>
                            </div>
                        </div>
                ...
                <div class="team-card">
                    ...
                    <div class="role-overlay">
                        <div class="role-overlay">
                            <div class="role-wrapper">
                                <span class="role-ketua">Ketua Tim</span>
                                <a href="https://wa.me/6285778092881" target="_blank" class="wa-icon">
                                    <i class="fa-brands fa-whatsapp"></i>
                                </a>
                            </div>
                        </div>
                ...
                <div class="team-card">
                    ...
                    <div class="role-overlay">
                        <div class="role-overlay">
                            <div class="role-wrapper">
                                <span class="role-anggota">Anggota Tim</span>
                                <a href="https://wa.me/6281374677799" target="_blank" class="wa-icon">
                                    <i class="fa-brands fa-whatsapp"></i>
                                </a>
                            </div>
                        </div>
            ...
            <div class="row gy-4">
                ...
                <div class="col-md-5">
                    <p>
                        ...
                        Vokasi di kawasan perdagangan dan pelabuhan bebas Batam, Bintan, dan Karimun Provinsi Kepulauan
                        Riau.
                        Polibatam berada di wilayah terdepan dan terluar Negara Kesatuan Republik Indonesia yang
                        berbatasan
                        langsung dengan perairan internasional.
                    </p>

                    <div class="d-flex gap-3 mt-3">
                        <a href="https://www.polibatam.ac.id/" target="_blank" class="social-icon"><i
                                class="fas fa-globe"></i></a>
                        <a href="https://www.instagram.com/polibatamofficial/" target="_blank" class="social-icon"><i
                                class="fab fa-instagram"></i></a>
                        <a href="https://www.youtube.com/@PolibatamTV" target="_blank" class="social-icon"><i
                                class="fab fa-youtube"></i></a>
                        <a href="https://www.facebook.com/polibatamofficial?locale=id_ID" target="_blank"
                            class="social-icon"><i class="fab fa-facebook"></i></a>
                        <a href="https://www.tiktok.com/@polibatamtv" target="_blank" class="social-icon"><i
