...
<header class="navbar">
            ...
            <div class="row justify-content-center">
                <div class="col-md-10">
                    ...
                    <p class="lead-text">
                        ...
                        Website ini hadir sebagai solusi manajemen perkuliahan mandiri yang membantu mahasiswa
                        mengorganisir jadwal yang padat secara lebih efektif dan terstruktur.
                        <div class="features-grid">
                            <div class="feature-item">
                                <i class="fas fa-calendar-check"></i>
                                <h4>Akses Real-Time</h4>
                                <p>Memungkinkan mahasiswa melihat jadwal kuliah terbaru, lokasi ruangan, dan informasi
                                    dosen pengampu secara instan.</p>
                            </div>
                            <div class="feature-item">
                            ...
                            <div class="feature-item">
                                ...
                                <h4>Keamanan Data</h4>
                                <p>Sistem login terintegrasi memastikan data jadwal dan catatan pribadi hanya dapat
                                    dikelola oleh pemilik akun yang sah.</p>
                            </div>
                        </div>
                </div>
            </div>
    ...
    <section class="team-section" id="tim">
        ...
        <p>Proyek "Jadwal Perkuliahan Mahasiswa (Pribadi)" ini dikembangkan oleh kelompok 6 dari kelas IF-Pagi-1C
            sebagai solusi inovatif untuk manajemen waktu akademik mahasiswa Teknik Informatika.</p>
            ...
            <div class="row gy-4">
                ...
                <div class="col-md-5">
                    <p>
                        ...
                        Riau.
                        Selain terletak di kawasan pusat pertumbuhan ekonomi nasional, Polibatam juga berada di wilayah
                        terdepan
                        dan terluar Negara Kesatuan Republik Indonesia yang berbatasan langsung dengan perairan
                        internasional.
                    </p>
